...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
  ...
  <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      ...
      <h1>
          ...
          <telerik:RadBinaryImage ID="RadBinaryImage1" runat="server" Height="50" ImageStorageLocation="Cache" AutoAdjustImageControlSize="false" />
       &nbsp;
          <asp:Label ID="lblVersion" runat="server" Text="  &nbsp;   Pallet Link" ></asp:Label>
    ...
    <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Metro" EnableEmbeddedSkins="false" >
      ...
      <asp:Panel ID="pnlCliente" class="panel panel-primary" runat="server" style="margin-bottom: 10px; margin-top: 9px;" Visible="False" HorizontalAlign="Center" Font-Bold="True" Font-Size="X-Large">
          ...
          &nbsp;&nbsp;
          <asp:DropDownList ID="cmbSelectCustomer1" runat="server" Font-Size="Large" Width="334px"></asp:DropDownList>
             ...
             <tr>
                 <td style="font-weight: bold">
                     ...
                     <asp:Panel ID="pnlPiezas" runat="server">
                           Piezas:
                           &nbsp;   &nbsp;  
                          <asp:TextBox ID="txtUnit" runat="server" AutoPostBack="True" style="text-align: center" Width="330px" OnTextChanged="txtUnit_TextChanged"></asp:TextBox>
                 ...
                 <td align="center" >
                  ...
                  <div style="overflow-x: auto; width =800px">  
                   ...
                   <asp:GridView ID="gvUnitsInfo" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="1" Font-Size="Small"
                        Height="50px" float="none" OnRowDataBound="gvUnitsInfo_RowDataBound" >
